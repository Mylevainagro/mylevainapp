...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-xl border-t border-gray-200/60 z-50 safe-area-bottom">
      <div className="max-w-lg mx-auto flex justify-around py-1.5">
        ...
        <div className="relative" ref={menuRef}>
          ...
          {moreOpen && (
            <div className="absolute bottom-full right-0 mb-3 glass rounded-2xl shadow-xl py-2 min-w-[180px] animate-slideDown">
