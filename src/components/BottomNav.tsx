...
const NAV_ITEMS = [
  ...
  { href: "/observations", label: "Observation", icon: "📝", exact: false },
  { href: "/historique", label: "Historique", icon: "📋", exact: false },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-emerald-100/60 z-50 safe-area-bottom">
      <div className="max-w-lg mx-auto flex justify-around py-1.5">
        ...
        <div className="relative" ref={menuRef}>
          ...
          >
            ...
            {moreActive && <div className="w-1 h-1 rounded-full bg-emerald-600 mt-0.5" />}
          </button>

          {moreOpen && (
            <div className="absolute bottom-full right-0 mb-3 bg-white border border-emerald-100 rounded-2xl shadow-xl py-2 min-w-[180px] animate-slideDown">
